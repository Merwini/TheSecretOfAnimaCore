...
public class WorkGiver_TakeAnimaAmberOutOfFont : WorkGiver
{
    ...
    public override Job NonScanJob(Pawn pawn)
    {
        if (pawn.Map?.Parent is not FontOfAnimaWorldObject fontWO)
        {
            ...
            Log.Error("WorkGiver_TakeAnimaAmberOutOfFont.NonScanJob run on map other than Font of Anima world object");
            return null;
        }
        ...
        {
            // Should have never gotten to this point due to ShouldSkip, just being safe
            Log.Error("WorkGiver_TakeAnimaAmberOutOfFont.NonScanJob run with null Font");
            return null;
        }
